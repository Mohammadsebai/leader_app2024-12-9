...
case 'internal-error':
return 'An irternal authentication error occurred. Please try again later.';
...
return 'The authDemain configuration is required for the action code verification link.';
