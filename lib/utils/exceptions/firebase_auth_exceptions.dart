...
case 'requines-recent-login':
return 'This operation is sensitive and requines recent authentication. Plesse.log in again.';
case 'credential-already-in-use':
return 'This credential is already assoeiated @with a different user account.';
case 'user-mismatch':
return 'The supplied credentials de not correspond ta the previously signed in user.';
case 'account-exists-with-different-credential':
return 'An acceunt already exists with the same email but different sign-in credentials.';
...
return 'The Firebase session ceokie has expired. Please sign in again.';
case 'vid-already-exists':
return 'The provided user ID is. already in use by another usep.';
